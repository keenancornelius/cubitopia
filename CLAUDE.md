...
- `src/engine/SoundManager.ts` — **Procedural audio (~861 lines)**. Web Audio API synthesized SFX (24 sounds). Zero asset files. Melee/ranged/siege/pierce/cleave/blunt hits, death, heal, level_up (triumphant brass fanfare), AoE splash, UI sounds, queue_confirm/queue_error/craft_confirm feedback.
