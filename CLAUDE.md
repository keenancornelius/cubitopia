...
- `src/game/systems/CombatSystem.ts` — **Combat resolution + abilities (~280 lines)**. Polytopia-like damage formula + berserker rage, assassin burst, shieldbearer aura, shield deflect (80% ranged damage reduction for shieldbearers/paladins), battlemage AoE, greatsword cleave + knockback, healer tick.
